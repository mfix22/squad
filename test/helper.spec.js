...
describe('Date utils', () => {
  it('Gets list of day with refDate in relative week position if numDays < 10', () => {
    expect(getNumDaysInView('4_DAY')).to.equal(4)
    expect(getNumDaysInView('WEEK')).to.equal(7)
    expect(getNumDaysInView('2_WEEK')).to.equal(14)
    expect(getNumDaysInView('MONTH')).to.equal(35)
    expect(getNumDaysInView(null)).to.equal(35)
  })
  ...
  it('Gets list of day with refDate in relative month position if numDays > 10', () => {
    const days = getChunkedDays(moment('2016-11-11T15:11:50-06:00').format()) // numDays defaults to 35
    expect(days).to.deep.equal([
      [
        '2016-10-26T15:11:50-05:00',
        '2016-10-27T15:11:50-05:00',
